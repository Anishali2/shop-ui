...
<Text style={[StyleSheet.textCenter,{fontSize:22,fontWeight:'700',marginBottom:20}]}>Are you sure you want to <Text style={{color:colors.primaryColor}}>Logout.</Text></Text>
    ...
    <View style={StyleSheet.leftPadding}>
        <MyContainer title={"Seller Profile"}/>
    </View>
...
<View style={[StyleSheet.flexRowSpaceBetween,{justifyContent:"space-around"}]}>
    ...
    <View >
      <Text onPress={() => navigate("SellerReview")} style={[StyleSheet.textCenter,{fontWeight:"700",color:colors.primaryColor}]}>97</Text>
      <Text style={[StyleSheet.textCenter,{}]}>Rewiews</Text>
    </View>
</View>
  </View>
    ...
    <View style={StyleSheet.leftPadding}>
        <TouchableOpacity style={StyleSheet.flexRowSpaceBetween} onPress={() => navigate('Account')}>
            <Text style={StyleSheet.newlabel}>Sales Summery</Text>
             <Back style={{
    ...
    <View style={[StyleSheet.line,{marginVertical:20,}]}/>
    <TouchableOpacity style={StyleSheet.flexRowSpaceBetween} onPress={() => navigate('Account')}>
            <Text style={StyleSheet.newlabel}>Manage My Store</Text>
            <Back style={{
                transform : [{ rotate: "180deg" }],
               marginRight:10
            }}/> 
    ...
    <View style={[StyleSheet.line,{marginVertical:20,}]}/>
    <TouchableOpacity style={StyleSheet.flexRowSpaceBetween} onPress={() => navigate('Account')}>
            <Text style={StyleSheet.newlabel}>Settings</Text>
            <Back style={{
                transform : [{ rotate: "180deg" }],
               marginRight:10
            }}/>
